...
public:
    ...
    void setupUi(QMainWindow *TestScreen)
    {
        ...
        Plot->setGeometry(QRect(0, 40, 521, 400));
        QFont font;
        ...
        label_audioIndicator->setObjectName("label_audioIndicator");
        ...
        label_DAC->setObjectName("label_DAC");
        ...
        label_freeze->setObjectName("label_freeze");
